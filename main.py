...
while(stopTheGame == False) :
    ...
    match mode :
        case 1 :
            ...
            print("\n\033[0;34mIn this mode, you have to find a number \033[1;37mbetween " + str(interval[0]) + " and " + str(interval[1]) + " included.\n")
        case 2 :
            print("\n\n\033[1;34mWELCOME IN THE \033[1;33mMEDIUM MODE")
            print("\n\033[0;34mIn this mode, you have to find a number \033[1;37mbetween " + str(interval[0]) + " and " + str(interval[1]) + " included.\n\033[0;34mYou have \033[1;37m" + str(chances) + " chances.\n")
        case 3 :
